...
export default function MediaTab({ showNotice }: NoticeProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {section === "gallery" && <GallerySection categories={["exterior", "rooms"]} sectionLabel="Gallery images" showNotice={showNotice} />}
      {section === "dining"  && <GallerySection categories={["dining"]} sectionLabel="Dining images" showNotice={showNotice} />}
    </div>
  );
}
